...
VERSION = "v2.2"
AUTHOR = "Hugh Knight"
LOG_FILE = ".access_counter.dat"  # Hidden data file for lifetime count
...
class DriveSpinnerApp:
    ...
    def poke_drive_loop(self):
        while self.is_running:
            ...
            # Alternate between Folder 1 and Folder 2
    ...
    def show_info(self):
        info_text = f"{APP_NAME}\nVersion: {VERSION}\nDeveloper: {AUTHOR}\n\n" \
                    ...
                    f"Total Accesses (Lifetime): {self.total_accesses}"
    ...
    def save_access_count(self):
        with open(LOG_FILE, 'wb') as f:
            pickle.dump(self.total_accesses, f)
